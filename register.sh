...
http POST http://paas:6000/bigdata/api/v1/products name=postgresqlbeta version=9.2.15 description='DO NOT USE, BETA versions of POSTGRESQL' logo_url='http://hadoop.cesga.es/img/postgresql-icon.gif' x-auth-token:$TOKEN
